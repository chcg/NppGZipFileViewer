...
public class Win32
{
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, NppMenuCmd lParam) => SendMessage(hWnd, Msg, new IntPtr(wParam), new IntPtr((uint)lParam));
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, IntPtr lParam) => SendMessage(hWnd, Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, int lParam) => SendMessage(hWnd, Msg, new IntPtr(wParam), new IntPtr(lParam));
    ...
    {
        IntPtr retval = SendMessage(hWnd, Msg, new IntPtr(wParam), out IntPtr outVal);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, IntPtr wParam, int lParam) => SendMessage(hWnd, Msg, wParam, new IntPtr(lParam));
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, [MarshalAs(UnmanagedType.LPWStr)] StringBuilder lParam) => SendMessage(hWnd, Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, uint Msg, int wParam, [MarshalAs(UnmanagedType.LPWStr)] string lParam) => SendMessage(hWnd, Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, IntPtr wParam, int lParam) => SendMessage(hWnd, (uint)Msg, wParam, new IntPtr(lParam));
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, int wParam, IntPtr lParam) => SendMessage(hWnd, (uint)Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, int wParam, string lParam) => SendMessage(hWnd, (uint)Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, int wParam, [MarshalAs(UnmanagedType.LPStr)] StringBuilder lParam) => SendMessage(hWnd, (uint)Msg, new IntPtr(wParam), lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, int wParam, int lParam) => SendMessage(hWnd, (uint)Msg, new IntPtr(wParam), new IntPtr(lParam));
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, SciMsg Msg, IntPtr wParam, IntPtr lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, IntPtr wParam, int lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, int wParam, int lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, int wParam, string lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, int wParam, StringBuilder lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
    ...
    /// at https://github.com/kbilsted/NotepadPlusPlusPluginPack.Net
    /// </summary>
    public static IntPtr SendMessage(IntPtr hWnd, NppMsg Msg, IntPtr wParam, IntPtr lParam) => SendMessage(hWnd, (uint)Msg, wParam, lParam);
