...
public class NotepadPPGateway : INotepadPPGateway
{
    ...
    public bool SetStatusBar(NppMsg statusBarType, string str) => Win32.SendMessage(PluginBase.nppData._nppHandle, (uint)NppMsg.NPPM_SETSTATUSBAR, (int)statusBarType, str) == IntPtr.Zero;

    public long GetBufferEncoding(IntPtr bufferId) => Win32.SendMessage(NppHandle, NppMsg.NPPM_GETBUFFERENCODING, bufferId, 0).ToInt64();
    ...
    public IntPtr GetCurrentBufferId() => Win32.SendMessage(NppHandle, NppMsg.NPPM_GETCURRENTBUFFERID, 0, 0);
